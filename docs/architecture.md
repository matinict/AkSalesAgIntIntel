...
└─────────────────────────────────────────────────────────────────┘
 ...
 ```
Below is your **fully updated, job-requirement–aligned `architecture.md`** with:

✔ Official Agent Names (as per Akij Resource email)
✔ Clean structure
✔ Diagrams
✔ Technical clarity
...
# 📘 **System Architecture – AkSalesAgIntIntel**

This document describes the end-to-end architecture of the **AI Agent & Agentic Intelligence System** developed for **Akij Resource**, as requested in the official project requirements.

The system uses a **multi-agent analytical pipeline**, an **LLM reasoning layer**, **n8n workflow automation**, and an **interactive chatbot interface** to deliver decision-grade insights built on sales data.

---

# 🧠 **1. Multi-Agent Analytical Framework**

The architecture follows the four analytical frameworks defined in the project requirements:

---

## **1️⃣ Descriptive Analytics Agent – “What has happened?”**

Responsible for historical and summary insights such as:

* Total sales, revenue, profit
* Region-wise / Channel-wise performance
* Product category distributions
* Month-over-month trends
* Top/Bottom customer segments

**Input:** Raw sales dataset
**Output:** Clean historical insight JSON

---

## **2️⃣ Diagnostic Analytics Agent – “Why did it happen?”**

Explains the reasons behind key trends using:

* Correlation analysis
* Root cause identification
* Underperforming product/region/channel discovery
* Seasonal or external effects
* Customer behavior patterns

**Output:** Cause-and-effect insights

---

## **3️⃣ Predictive Analytics Agent – “What is likely to happen?”**

Forecasts near-term performance:

* Revenue forecast
* Product/region growth trends
* Declining segments
* Customer churn risks
* Demand estimation

**Output:** Data-backed forecast JSON

---

## **4️⃣ Prescriptive Analytics Agent – “What actions should be taken?”**

Provides actionable recommendations:

* Priority actions for sales improvement
* Corrective steps
* Forecast-driven strategy
* Automation-ready workflow instructions
* Structured JSON output for n8n

**Output:** Action plan + n8n payload
...
└──────────────────────────────┘
      ...
      ▼            ▼
┌────────────────────────┐       ┌─────────────────────────────┐
│ Chatbot Interface      │       │ n8n Workflow Generator       │
│ (Streamlit UI)         │       │ (Automation Payload Builder) │
└────────────────────────┘       └─────────────────────────────┘
      │
      ▼
┌───────────────────────────────────────────────────────────────┐
│ Streamlit Analytics Dashboard (KPIs, Charts, Trends)           │
└───────────────────────────────────────────────────────────────┘
```

---

# 🧩 **3. Agent Coordination Layer (LangChain)**

All agents are orchestrated using **LangChain**, enabling:
...
Each agent acts as an **independent specialist**, collaborating through a **controller agent** implemented in `sales_agents.py`.

---

# ⚡ **4. Automation Layer (n8n Workflow Builder)**

The Prescriptive Agent generates:

* Sales alert payloads
* Action scoring (critical/high/medium)
* Workflow-ready JSON structures
* Direct n8n automation triggers

This allows Akij Resource to:

* Send automated alerts to sales teams
* Trigger CRM actions
* Assign tasks
* Generate sales follow-up workflows

---

# 🖥️ **5. Interface Layer**

### **A. Conversational Assistant (chatbot_ui.py)**
...
* Report generation
* Region / product / segment filtering

### **B. Streamlit Dashboard**

Offers decision-maker-friendly visuals:
...
| LLM Models            | GPT / Gemini / Local Models |
| Data Processing       | Pandas, NumPy               |
| Dashboard             | Streamlit                   |
| Automation            | n8n                         |
| Visualizations        | Plotly                      |
| Storage               | CSV (Demo), SQL optional    |

---

# 📌 **7. Summary**

This architecture fully aligns with the expectations of the **AI Agent & Agentic Intelligence Specialist** role by combining:

* Multi-agent analytical reasoning
* LLM orchestration
* Predictive modeling
